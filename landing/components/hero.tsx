...
export function Hero() {
  return (
    <header className="relative mx-auto max-w-6xl px-7 py-20 text-center">
      ...
      <h1 className="font-display mx-auto text-5xl font-bold tracking-tight text-balance md:text-7xl">
        JSON to{" "}
